const form = document.getElementById("form").addEventListener('submit', submit => {
	...
	let teamId = document.getElementById("team").value//Traemos desde el HTMl el piloto que se desea consultar

	submit.preventDefault()
	
	const datosApi = async () => {
		try{
			const respuesta = await fetch(`https://v1.formula-1.api-sports.io/teams?id=${teamId}`, {
				"method": "GET",
				"headers": {
